      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52 mx-auto mb-8"
          >
            {/* Glow effect */}
            <motion.div
            ...
            {/* Image container */}
            <motion.div
              className="absolute inset-2 rounded-full overflow-hidden ring-4 ring-blue-400/40 dark:ring-blue-500/30 shadow-[0_20px_50px_rgba(59,130,246,0.35)]"
