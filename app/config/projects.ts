...
export const projects: Project[] = [
  {
    ...
    description:
      "Transformamos la experiencia de compra de café premium en una aventura digital inmersiva, conectando productores locales con amantes del café en todo el mundo.",
    longDescription:
    ...
    images: [
      {
        url: "/img/Proyecto 1/lafelicidaHome.webp",
        caption:
          "Landing page moderna y atractiva que transmite la esencia de tu marca",
      },
      {
        url: "/img/Proyecto 1/lafelicidaCafe.webp",
        caption: "Catálogo de productos que destaca la calidad de tu oferta",
      },
      {
        url: "/img/Proyecto 1/lafelicidaDetalleCafe.webp",
        caption:
          "Detalles de producto que generan confianza y aumentan conversiones",
      },
      {
        url: "/img/Proyecto 1/lafelicidaCarrito.webp",
      ...
      {
        url: "/img/Proyecto 1/lafelicidaAgenteIA.webp",
  ...
  },
  {
    ...
    description:
      "Plataforma de comercio electrónico con carrito de compras, pagos en línea y sistema de inventario en tiempo real.",
    longDescription:
      "Plataforma completa de e-commerce con gestión de productos, carrito de compras, pasarela de pagos integrada, sistema de inventario automatizado y panel de administración.",
    images: [
      {
        url: "/img/Proyecto 1/lafelicidaHome.webp",
        caption:
          "Catálogo de productos e-commerce desarrollado con Flutter y Supabase",
      },
      {
        url: "/img/Proyecto 1/lafelicidaCafe.webp",
  ...
  },
  {
    ...
    description:
      "Aplicación de mensajería instantánea con funciones de chat grupal, mensajes directos y compartición de archivos.",
    longDescription:
      "App de mensajería con chat en tiempo real, grupos, llamadas de voz, compartición de multimedia, cifrado end-to-end y sincronización multiplataforma.",
    images: [
      {
        url: "/img/Proyecto 1/lafelicidaHome.webp",
